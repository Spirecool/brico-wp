...
function loop_end_action()
{
    ...
    ?>
        <p class="after-loop">
            <?php
            echo do_shortcode('[banniere-titre src="http://localhost/bricotips-oc/wp-content/uploads/2023/03/banniere-image.webp" titre="BricoTips"]');
            ?>
        </p>
    <?php
    endif;
...
// on affiche ce texte uniquement sur le premier article
$shown = false;
